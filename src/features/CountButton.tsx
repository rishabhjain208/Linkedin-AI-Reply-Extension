                  ...
                  <div className="chat-message p-2">
                    <div className="flex items-end justify-end">
                      <div className="flex flex-col space-y-2 text-xl max-w-xl mx-2 order-1 items-end">
                        <span className="px-4 py-2 rounded-lg inline-block rounded-br-none bg-gray-300 text-black">
                          {message}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="chat-message p-2">
                    <div className="flex items-end">
                      <div className="flex flex-col space-y-2 text-xl max-w-xl mx-2 order-2 items-start">
                        <span className="px-4 py-2 rounded-lg inline-block bg-blue-300 text-black">
                          {displayText}
                        </span>
                      </div>
                    </div>
                ...
                <form className="space-y-4">
                  ...
                  {generate ? (
                    ...
                    >
                      <button
                        type="button"
                        className="text-black bg-white border border-black hover:bg-gray-200  rounded-md px-5 py-2.5 dark:hover:bg-gray-600 dark:hover:text-black"
                      ...
                      <button
                        type="button"
                        className="text-white bg-blue-700 hover:bg-blue-800   focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-5 py-2.5 text-center dark:hover:bg-blue-600 dark:hover:text-blue-700 dark:focus:ring-blue-800"
                      >
